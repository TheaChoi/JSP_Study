...
<body>
	...
	%>
		...
		<ul class="sidebar-nav">
			...
			<li id="write"><i class="fa fa-pencil-square-o navicon"></i><a href="/HamanGaja/admin/write.jsp">글쓰기</a></li>
			<li id="tripList"><i class="fa fa-fort-awesome navicon"></i><a href="/HamanGaja/admin/List.board?pageNo=0&pageSize=5&viewStart=0&viewEnd=5&type=관광지">관광지</a></li>
<!-- 			HOME에서 넘어가려면 절대경로여야 오류없이 찾아간다. -->
			<li id="restaurantList"><i class="fa fa-cutlery navicon"></i><a href="/HamanGaja/admin/List.board?pageNo=0&pageSize=5&viewStart=0&viewEnd=5&type=맛집">맛집</a></li>
			<li id="specialtyList"><i class="fa fa-shopping-basket navicon"></i><a href="/HamanGaja/admin/List.board?pageNo=0&pageSize=5&viewStart=0&viewEnd=5&type=특산물">특산물</a></li>
	...
	<nav id="slidebar-wrapper">
		...
		<ul class="sidebar-nav">
			...
			<li id="trip"><i class="fa fa-fort-awesome navicon"></i><a href="list.user?type=trip&pageNo=0&pageSize=5&viewStart=0&viewEnd=5&search=">관광지</a></li>
			<li id="restaurant"><i class="fa fa-cutlery navicon"></i><a href="list.user?type=restaurant&pageNo=0&pageSize=5&viewStart=0&viewEnd=5&search=">맛집</a></li>
			<li id="specialty"><i class="fa fa-shopping-basket navicon"></i><a href="list.user?type=specialty&pageNo=0&pageSize=5&viewStart=0&viewEnd=5&search=">특산물</a></li>
	...
	<nav id="slidebar-wrapper">
		...
		<ul class="sidebar-nav">
			...
			<li id="trip"><i class="fa fa-fort-awesome navicon"></i><a href="list.user?type=trip&pageNo=0&pageSize=5&viewStart=0&viewEnd=5&search=">관광지</a></li>
			<li id="restaurant"><i class="fa fa-cutlery navicon"></i><a href="list.user?type=restaurant&pageNo=0&pageSize=5&viewStart=0&viewEnd=5&search=">맛집</a></li>
			<li id="specialty"><i class="fa fa-shopping-basket navicon"></i><a href="list.user?type=specialty&pageNo=0&pageSize=5&viewStart=0&viewEnd=4&search=">특산물</a></li>
		</ul>
	</nav>
	<%
		}
