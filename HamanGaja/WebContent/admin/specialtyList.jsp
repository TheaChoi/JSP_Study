...
<!-- 					hidden 태그는 보이지 않지만 파라미터로 넘어간다 -->
	...
	<%
		ArrayList<ListDTOOut> list = (ArrayList<ListDTOOut>)request.getAttribute("SPECIALTY");
		PageDTOOut pg = (PageDTOOut) request.getAttribute("PAGEOUT");
	%>
	<!-- sub contents start -->
	<div class="adminbox">
	<h1 style="font-size:20px; color:#f26522; padding:10px; font-weight:bold;">특산물 목록</h1>
		<table class="list">
